...
export default function SubjectSection({ subjectId, studentProfile, onLaunchQuiz }: SubjectSectionProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-xs text-left">
            ...
            <span className="px-3.5 py-1.5 bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-bold rounded-xl inline-block">
            ...
            {topics.map((topic) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-2xl border transition-all flex items-center justify-between ${isActive ? "bg-indigo-50/40 border-indigo-300 ring-2 ring-indigo-50" : "bg-white border-slate-100 hover:border-slate-300"}`}
                >
                  <div className="flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl shrink-0 ${isActive ? "bg-indigo-600 text-white" : "bg-slate-100 text-slate-600"}`}>
